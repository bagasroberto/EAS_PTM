// ignore_for_file: use_key_in_widget_constructors, must_be_immutable, prefer_const_constructors, deprecated_member_use
//@dart=2.9
...
class DosenEdit extends StatefulWidget {
  List list;
  int index;

  DosenEdit({this.list, this.index});
  @override
  _DosenEditState createState() => _DosenEditState();
}

class _DosenEditState extends State<DosenEdit> {
  //Image
  File imageFile;
  ...
  TextEditingController controllerKode_dsn = TextEditingController();
  ...
  void editData() {
    var url = "http://192.168.43.230/crud_flutter/editdata_dosen.php";
    http.post(Uri.parse(url), body: {
      "kode_dsn": widget.list[widget.index]['kode_dsn'],
  ...
  void initState() {
    controllerKode_dsn =
        TextEditingController(text: widget.list[widget.index]['kode_dsn']);
    controllerNama =
        TextEditingController(text: widget.list[widget.index]['nama']);
    controllerAlamat =
        TextEditingController(text: widget.list[widget.index]['alamat']);
    selectedDate = DateTime.parse(widget.list[widget.index]['tgl_lahir']);

    prodi = widget.list[widget.index]['prodi'];
    setState(() {
      if (prodi == 'Ilmu Komunikasi') {
        _value = 1;
      } else if (prodi == 'Ilmu Hukum') {
        _value = 2;
      } else if (prodi == 'Manajemen Bisnis') {
        _value = 3;
      } else if (prodi == 'Ilmu Psikologi') {
        _value = 4;
      } else if (prodi == 'Teknik Informatika') {
        _value = 5;
      } else if (prodi == 'Sastra Inggris') {
        _value = 6;
      } else if (prodi == 'Teknologi Listrik') {
        _value = 7;
      }
    });
    ...
    setState(() {
      if (fakultas == 'Ilmu Sosial dan Politik') {
        _value1 = 1;
      } else if (fakultas == 'Hukum') {
        _value1 = 2;
      } else if (fakultas == 'Ekonomi dan Bisnis') {
        _value1 = 3;
      } else if (fakultas == 'Psikologi') {
        _value1 = 4;
      } else if (fakultas == 'Teknik') {
        _value1 = 5;
      } else if (fakultas == 'Ilmu Budaya') {
        _value1 = 6;
    ...
    controllerNoTelp =
        TextEditingController(text: widget.list[widget.index]['no_telp']);
