...
class DosenTambahData extends StatefulWidget {
  const DosenTambahData({Key key}) : super(key: key);

  @override
  DosenTambahDataState createState() => DosenTambahDataState();
}

class DosenTambahDataState extends State<DosenTambahData> {
  //Image
  File imageFile;
  ...
  void addData() {
    var url = "http://192.168.43.230/crud_flutter/adddata_dosen.php";
    http.post(Uri.parse(url), body: {
      "kode_dsn": controllerKode.text,
