...
class MahasiswaEdit extends StatefulWidget {
  ...
  MahasiswaEdit({this.list, this.index});
  @override
...
class _MahasiswaEditState extends State<MahasiswaEdit> {
  ...
  void editData() {
    var url = "http://192.168.43.230/crud_flutter/editdata.php";
    http.post(Uri.parse(url), body: {
      "nbi": widget.list[widget.index]['nbi'],
  ...
  void initState() {
    controllerNbi =
        TextEditingController(text: widget.list[widget.index]['nbi']);
    controllerNama =
    ...
    controllerIpk =
        TextEditingController(text: widget.list[widget.index]['ipk']);
    controllerDosenwali =
        TextEditingController(text: widget.list[widget.index]['dosen_wali']);
    super.initState();
  }
          ...
          children: [
            Stack(
              children: [
                ...
                Positioned(
                  top: MediaQuery.of(context).size.height / 1.01,
                  right: MediaQuery.of(context).size.width / 7.4,
                  child: Container(
                      height: 70,
                      child: Container(
